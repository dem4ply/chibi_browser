...
coverage: ## check code coverage quickly with the default Python
	coverage run --source chibi_browser setup.py test
	coverage report -m
	coverage html
	$(BROWSER) coverage_html_report/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/chibi_browser.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ chibi_browser
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
pep8:
	...
	@pycodestyle --statistics chibi_browser tests

flakes:
	@echo "Running flakes tests..."
	@pyflakes chibi_browser tests
